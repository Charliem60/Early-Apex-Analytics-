...
- Unzip the file. Then using command prompt and pip, go to the directory of this repository once unzipped and run the following commands. This has to be run to install the packages needed: `python -m pip install -r requirements.txt`. Then also run `python -m pip install streamlit` which installs the streamlit to display the GUI used for the app.
...
<img width="800" height="395" alt="gif 1" src="https://github.com/user-attachments/assets/6b162dae-e49d-46bc-b90d-da11fec6a4f1" />
...
<img width="1131" height="561" alt="image" src="https://github.com/user-attachments/assets/cce86f74-d968-4f59-9f96-2f54e23a9479" />
...
<img width="800" height="434" alt="gif 2" src="https://github.com/user-attachments/assets/26cd2b94-d706-4020-9fc6-abfbbfc67b6f" />
...
<img width="800" height="398" alt="final gif" src="https://github.com/user-attachments/assets/e8049da4-e1ac-4265-9887-910f1ac98ba3" />
